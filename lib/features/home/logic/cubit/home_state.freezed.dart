...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CategoryData?>? categories)
        categoriesSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CategoryData?>? categories)? categoriesSuccess,
...
class _$CategoriesSuccessImpl implements CategoriesSuccess {
  const _$CategoriesSuccessImpl(final List<CategoryData?>? categories)
...
abstract class CategoriesSuccess implements HomeState {
  const factory CategoriesSuccess(final List<CategoryData?>? categories) =
